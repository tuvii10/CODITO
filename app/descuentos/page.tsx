...
const FALLBACK_PROMOS: BankPromo[] = [
  ...
  { banco: 'Mercado Pago',    icon: '💙', color: '#009ee3', tarjeta: 'Tarjeta MP / QR',          descuento: 25, dias: ['Siempre'],          supers: ['Supermercados seleccionados'],               tope: null,                 nota: 'Verificar descuento activo en la app' },
  { banco: 'Personal Pay',    icon: '🟢', color: '#00a550', tarjeta: 'Visa Prepaga',             descuento: 25, dias: ['Siempre'],          supers: ['Supermercados seleccionados'],               tope: null,                 nota: 'Requiere nivel 2 en la app' },
]
