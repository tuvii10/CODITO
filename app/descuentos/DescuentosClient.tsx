...
export default function DescuentosClient({ promos, updatedAt }: { promos: BankPromo[]; updatedAt: string | null }) {
  ...
  const lastUpdate = updatedAt
    ? new Date(updatedAt).toLocaleDateString('es-AR', { day: 'numeric', month: 'long', hour: '2-digit', minute: '2-digit' })
    : null
  ...
  return (
    <div style={{ maxWidth: 800, margin: '0 auto' }}>
      ...
      <p style={{ fontSize: 11, color: '#a1a1aa', textAlign: 'center', lineHeight: 1.6, marginBottom: 40 }}>
        Datos verificados y actualizados automáticamente cada 24hs · Verificar siempre en el sitio de tu banco
      </p>
    </div>
  )
}
